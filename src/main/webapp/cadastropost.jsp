...
<body>
    <div class="container-fluid bg-info p-3">
        ...
        <div class="row text-center mb-3"><h1>Criar Postagem</h1></div>

        <form action="cadastropost.jsp" method="POST" id="formpost">
            <div class="row mb-3">
                <label for="autor" class="col-1 text-end col-form-label">Autor</label>
                <div class="col"><input type="text" id="autor" name="autor" placeholder="Informe o usuário do autor" class="form-control" maxlength="20"></div>
            </div>

            <div class="row mb-3">
                <label for="titulo" class="col-1 text-end col-form-label">Título</label>
                <div class="col"><input type="text" id="titulo" name="titulo" placeholder="Informe o título da postagem" class="form-control" maxlength="90"></div>
            </div>

            <div class="row mb-3">
                <label for="conteudo" class="col-1 text-end col-form-label">Conteudo</label>
                <div class="col"><input type="text" id="conteudo" name="conteudo" placeholder="Informe o texto da postagem" class="form-control" maxlength="200"></div>
            </div>
    ...
    <%
        ...
        if ( autor != null && titulo != null && conteudo != null && !autor.equals("") && !titulo.equals("") && !conteudo.equals("") ) {
            DaoPostagem.salvar(new Postagem(titulo, autor, conteudo));
            out.write("<script>cadastrouPost()</script>");
        }
    %>
</body>
</html>